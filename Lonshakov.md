...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: Потому что в одном документе слово может встретиться несколько раз.
```
...
```
# 3.4 Ответ: потому что лексико-грамматический поиск работает только для поиска слов и словоформ, не для словосочетаний.
```
